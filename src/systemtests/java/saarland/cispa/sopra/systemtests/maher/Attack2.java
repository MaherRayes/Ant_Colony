...
public class Attack2 extends SystemTest {
    @Override
    public void test(GameInfo gameInfo) {
        ...
        if(wi.getFieldAt(1,1).getFood() != 0 || wi.getScore('B') != 3){
            fail("The Base took the points");
        }
    ...
    private WorldInfo simGame(int round, GameInfo g) {
        ...
        return g.simulate(round, 42, map, brain, brain,brain,brain2);
