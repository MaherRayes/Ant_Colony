...
public class SenseMarker2 extends BaseTest {
    ...
    protected void test(GameInfo gameInfo) {
       setGameInfo(gameInfo);
        ...
        String brain = createNewBrain( "mark 1", "sense here marker 0 else 5", "sense here marker 1 else 4", "jump 3", "jump 4", "jump 5");

        simulate(10, 42, map, brain, trivialBrain());

        // initial direction: northwest
        verifyAnt(new AntTestObject(0, 5));


        verifyMarker(0, 0, 'A', false, true, false, false);
