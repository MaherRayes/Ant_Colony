...
public class SenseMarker2SOPRAKANNWOHLKEINEDOPPELTENKLASSENDASISTABERSCHADE extends SenseTest{

    // TODO currently commented out. What is up here?


    public SenseMarker2SOPRAKANNWOHLKEINEDOPPELTENKLASSENDASISTABERSCHADE() {
        super('.');
    }
    ...
    protected void test(GameInfo gameInfo) {
        ...
        String brain = createNewBrain( "mark 1", "sense here marker 0 else 3", "jump 2", "jump 3");
